...
awards <- fread("../data/awards.csv") %>% .[language == "en"]
...
### Household income and the inidence of first psychiatric hospital admissions
...
- Suokas K, Gutvilig M, Pirkola S, Lumme S, Hakulinen C. Enhancing the accuracy of register-based metrics: Comparing methods for handling overlapping psychiatric register entries in Finnish healthcare registries. Submitted.
